...
export default function App(){
  ...
  return <div className="app-shell">
    ...
    <div className="main-shell">
      ...
      <a className="repository-link" href="https://github.com/Noah0615/webcapture" target="_blank" rel="noreferrer" aria-label={locale==='ko'?'GitHub 공개 저장소 열기':'Open public GitHub repository'}>GitHub <ArrowRight size={14}/></a>
      <header className="topbar"><div className="breadcrumb">워크스페이스 <span>/</span><strong>{view==='studio'?'캡처 스튜디오':'내 보관함'}</strong></div><div className="topbar-right"><span className="environment"><span className={isDesktop?'status-dot':'status-dot web'}/>{isDesktop?'로컬 엔진 연결됨':'웹 체험 버전'}</span></div></header>
      <main>
