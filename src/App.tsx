...
export default function App(){
  ...
  const [title,setTitle]=useState('새로운 리서치');
  ...
  return <div className="app-shell">
    ...
    <div className="main-shell">
      <header className="topbar"><div className="breadcrumb">워크스페이스 <span>/</span><strong>{view==='studio'?'캡처 스튜디오':'내 보관함'}</strong></div><div className="topbar-right"><span className="environment"><span className={isDesktop?'status-dot':'status-dot web'}/>{isDesktop?'로컬 엔진 연결됨':'웹 체험 버전'}</span><a className="github-link" href="https://github.com/Noah0615/webcapture" target="_blank" rel="noreferrer">GitHub <ArrowRight size={14}/></a></div></header>
      <main>
